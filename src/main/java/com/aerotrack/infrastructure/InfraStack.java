...
public class InfraStack extends Stack {
    ...
    public InfraStack(final Construct scope, final String id, final StackProps props) {
        ...
        Table flightsTable = Table.Builder.create(this, getResourceName("FlightsTable"))
        ...
        RestApi queryRestApi = RestApi.Builder.create(this, getResourceName("RestApiGateway"))
        ...
        UsagePlan usagePlan = UsagePlan.Builder.create(this, getResourceName("UsagePlan"))
        ...
        Function queryFunction = new Function(this, getResourceName("QueryLambda"), FunctionProps.builder()
        ...
        EventbridgeToLambda refreshEvent = EventbridgeToLambda.Builder.create(this, getResourceName("EventBridgeRefresh"))
        ...
        Bucket bucket = Bucket.Builder.create(this, getResourceName("AerotrackBucket"))
        ...
        BucketDeployment airportsDeployment = BucketDeployment.Builder.create(this, getResourceName("AirportsDeployment"))
